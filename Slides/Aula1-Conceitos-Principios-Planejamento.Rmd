...
É o modo como os tratamentos são designados às parcelas experimentais `r Citep(myBib, "dias2009biometria", .opts = list(max.names = 2, longnamesfirst = F))`.

Os principais delineamentos experimentais utilizados são:
 
- Delineamento inteiramente casualizado;
- Delineamento em blocos casualizados; e 
...
É uma técnica que permite decompor a variação total observada nos dados experimentais em causas conhecidas e não conhecidas.
...
-> O quanto da variação observada no experimento é devido ao erro experimental (**fatores não-controlados ou variação do acaso**)?

-> O quanto é devido às influências dos tratamentos experimentais (**fatores controlados**)?
]
...
É a variação devida ao efeito dos fatores não-controlados (acaso/aleatório).
