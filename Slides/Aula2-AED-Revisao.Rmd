...
Soma de Quadrados de Resíduos (SQR) = **1.7757** (Variação global)

Mas, deseja-se saber o quanto, em média, é essa dispersão:

n - 1: Grau de liberdade: A ideia é penalizar 
