...
.font200[**Parte 3 <br> Medidas de dispersão (ou afastamento)**]
...
## Medidas de dispersão (ou afastamento)
<br>
...
### Por que medir a variância dos dados?
...
.pull-right-5[
Um experimento foi conduzido para avaliar dois tipos de substratos (Solo Arenoso + Matéria Orgânica - SA+MO e Solo Arenoso-SA) no crescimento de uma espécie florestal. Após 30 dias de germinadas as sementes, a altura das plântulas, em cm, foi medida.

- **Pergunta**: Baseado no crescimento em altura, qual o melhor substrato para a produção de mudas da espécie?
...
- Portanto, "olhar" apenas para média pode conduzir à indicação equivocada do
melhor tratamento.
]
