...
### A necessidade de novos estimadores de dispersão.
<br>
...
`r anicon::faa("hand-point-right", animate="horizontal")` Assim, surgiram estimadores que estimam a dispersão dos dados tomando por referência uma medida de centralidade da distribuição, comumente a média aritmética.

Os principais são: .green[desvio padrão, variância e coeficiente de variação].
