...
A função `table()`: gera uma tabela de frequência. 
<br>

Pode-se criar uma função para retornar o valor modal.
]
...
.red[**Importante**]: Ao contrário da média e da mediana, a moda pode ser determinada para variáveis qualitativas.
