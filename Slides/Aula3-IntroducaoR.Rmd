...
### Vetores - Função .blue[seq()] (sequence)
<br>
...
### Vetores - Função .blue[rep()] (replicate)
<br>
...
### Vetores - Função .blue[scan()]
<br>

**Atividade**: Use a função .blue[scan()] para criar vetores para as variáveis da tabela a seguir diretamente no R console:
<br>
