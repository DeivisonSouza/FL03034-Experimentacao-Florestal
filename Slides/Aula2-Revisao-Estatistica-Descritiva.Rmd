...
```{r ref.label="g1", echo=FALSE, eval=TRUE, collapse=T, out.width='70%', fig.align='center', fig.cap='', dpi=600}
```
...
```{r ref.label="g2", echo=FALSE, eval=TRUE, collapse=T, out.width='70%', fig.align='center', fig.cap='', dpi=600}
```
