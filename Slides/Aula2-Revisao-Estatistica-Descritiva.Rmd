...
Por exemplo, um Engenheiro Florestal realiza um IF e registra as informações de espécie, diâmetro a 1,30m do solo($d_{1,3}$), altura comercial e qualidade de fuste. Em seguida, realiza um resumo para a espécie *Cedrela odorata*.
