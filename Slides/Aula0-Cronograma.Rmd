...
Aulas remotas síncronas, realização de atividades complementares e avaliações de desempenho. 

Link de acesso: [Sala Remota](https://meet.google.com/zos-kvfj-rrg)
...
- Formulários de avaliação do Google Form, com perguntas discursivas e objetivas sobre o tema;
- Atividades extraclasse sobre os assuntos abordados;
- Debates síncronos com temas da aula;
- Seminários síncronos com temas pré-estabelecidos em grupo;
- Pesquisa bibliográfica – pesquisa de artigos científico, vídeos e livros; e
- Indicação de palestras síncronas relacionadas aos temas abordados na disciplina.
