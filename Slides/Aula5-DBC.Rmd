...
.font80[
- É o tipo de delineamento experimental indicado quando existe uma .blue[**causa (ou fonte de variação)**] que deseja-se .blue[**controlar**] no no experimento.
...
- A ideia principal é .blue[**evidenciar os efeitos dos tratamentos**] na variável resposta.
- Não controlar essa fonte de variação (adicional e reconhecida) pode .blue[**mascarar as diferenças entre os tratamentos**] e conduzir à interpretações equivocadas. 
- Por exemplo, em um experimento de competição de progênies implantado em região com gradiente de fertilidade de solo, a maior média de crescimento em DAP para determinada progênie pode estar relacionada ao fato de seus indivíduos estarem estabelecidos na região de maior fertilidade do solo.
...
- O CL é uma estratégia para .blue[**diminuir o efeito da heterogeneidade**] da área experimental sobre os tratamentos.
