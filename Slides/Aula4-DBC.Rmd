...
## `r anicon::faa("pagelines", animate="horizontal", colour="green")` Delineamento em Blocos `r anicon::faa("pagelines", animate="horizontal", colour="green")` <br> Casualizados
...
[3 - Fonte de variação adicional](#fv)

[4 - Controle Local](#cl)

[5 - Princípios básicos](#pb)

[6 - Croqui de experimento em DBC - Exemplo](#croqui)
...
&nbsp;&nbsp;[1.1 - ANOVA para experimento em DBC - Fator único](#anovadbc)
...
.font90[
Um experimento de competição de 7 procedências florestais de *Eucalyptus grandis* foi conduzido sob o Delineamento em Blocos Casualizados (DBC), com 4 blocos. Os dados apresentados na tabela a seguir correspodem à produção de madeira, em m³/ha, nas parcelas experimentais. Assim, pede-se:
<br><br>
...
**Existe diferença** significativa entre as **médias** de produção de madeira, em m³/ha, para pelo menos duas procedências de *Eucalyptus grandis*.
]
]
...
.font90[
- Existe alguma procedência que apresentou produção volumétrica de madeira significativamente maior do que outra?
- A resposta para esta pergunta será alcançada aplicando-se o teste de hipótese (Teste F) da ANOVA-DBC.
]
