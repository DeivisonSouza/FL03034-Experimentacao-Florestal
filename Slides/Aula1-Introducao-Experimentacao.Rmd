...
É quando as unidades experimentais são subdivididas em grupos menores e homogêneos para algum fator. 
...
**Situação**: Existe um fator de variação para controlar (experimentos de campo - Fertilidade do solo)
