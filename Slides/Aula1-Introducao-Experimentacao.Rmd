...
knitr::include_graphics("https://media3.giphy.com/media/xT0xenLh8rnYKD9lYY/giphy-downsized.gif")
```
<div style='font-size:50%'>(Available at [http://gph.is/2j40zZ4](http://gph.is/2j40zZ4), jul 19, 2021)</div>
...
**Exemplos**
<br>
- Investigar a sobrevivência e os padrões de crescimento de espécies florestais
nativas de diferentes grupos ecológicos crescendo em área alterada no Amazonas ([Nogueira et al., 2015](https://periodicos.ufra.edu.br/index.php/ajaes/article/view/2101)).
...
**Exemplos** (Dever de casa!)

Atividade: Escolher uma pesquisa experimental na área florestal que tenha usado o DQL.
<br>

.pull-left-4[
1) Título do trabalho

2) Períodico de publicação

3) Objetivo

4) Delineamento utilizado (Tratamentos, repetições)
]

.pull-right-4[
5) Motivação para uso do DQL
