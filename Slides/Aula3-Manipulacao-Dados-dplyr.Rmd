...
```{r sel, echo=F, eval=F}
select(data, Nome_Comum) %>% CustomDT
```
]
...
```{r echo=TRUE, eval=FALSE}
data %>% 
  select(Nome_Comum, HC, QF)
```
]

```{r sel2, echo=F, eval=F}
select(data, Nome_Comum, HC, QF) %>% CustomDT
```
]
