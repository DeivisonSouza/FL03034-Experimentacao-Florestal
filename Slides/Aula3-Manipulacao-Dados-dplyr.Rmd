...
- O pacote dplyr é essencialmente um conjunto de funções projetadas para a **manipulação de dados**.
...
- **Cheatsheet do RStudio**: Help $\rightarrow$ Cheatsheets $\rightarrow$ Data Transformation with dplyr


```{r echo=FALSE, out.width='10%', fig.align='left', fig.cap='', dpi=600}
knitr::include_graphics("https://dplyr.tidyverse.org/logo.png")
```
