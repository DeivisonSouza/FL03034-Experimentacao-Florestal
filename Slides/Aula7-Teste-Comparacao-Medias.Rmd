...
.pull-right-4[
.font90[
```{r ref.label="tukey", echo=FALSE, eval=TRUE, collapse=T}
```
]
]
...
- **Ideia básica**: realizar .green[comparações par-a-par] entre as médias dos tratamentos.
- É conhecido como .green[Teste de Intervalo Múltiplo de Duncan] (Duncan's new multiple range test - MRT).
]
]
