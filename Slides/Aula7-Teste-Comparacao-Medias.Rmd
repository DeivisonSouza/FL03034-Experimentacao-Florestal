...
\Large
\begin{equation*}
\hat{C}_1 = \hat{m}_{maior} - \hat{m}_{menor}\\
\hat{C}_1 = 6,78 - 5,25\\
...
\normalsize
\begin{equation*}
R_m = z_m\sqrt{\frac{QMR}{r}} = 3,312\sqrt{\frac{0,261}{4}} = \color{red}{0,846cm}
\end{equation*}
$$
<br>
.font70[
...
- $\hat{C}_1 > R_m$: Rejeita-se H<sub>0</sub>
...
.pull-right-4[
.font70[
- Então, o cálculo de $\hat{C}_2$ e $\hat{C}_3$ fica:
<br>
