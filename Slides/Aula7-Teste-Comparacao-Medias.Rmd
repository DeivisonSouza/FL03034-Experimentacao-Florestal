...
[1 - Delineamento experimental - Conceito](#tcm)
...
- Na ANOVA, o .blue[teste F] é usado para avaliar, estatisticamente, a existência de evidências de .blue[igualdade entre as médias de tratamentos].
]
]
...
.pull-right-4[
.font80[
.center[**Surge um nova pergunta...**]

.green[Quais tratamentos possuem médias iguais e quais possuem médias diferentes, do ponto de vista estatístico?]

- Para responder essa pergunta foram idealizados os .blue[testes de comparações de médias].
- A ideia básica é realizar .blue[comparações par-a-par] entre as médias dos tratamentos, e inferir se estas são diferentes do ponto de vista estatístico.
- Existem vários testes de comparações de médias. Mas, estudaremos 2: .blue[Teste de Tukey e Teste de Duncan].
]
]
