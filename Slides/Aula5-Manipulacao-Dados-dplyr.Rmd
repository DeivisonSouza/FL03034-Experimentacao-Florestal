...
<br>
## `r anicon::faa("pagelines", animate="horizontal", colour="green")` Importação e Manipulação <br> de dados: readr e dplyr `r anicon::faa("pagelines", animate="horizontal", colour="green")`
...
<br>
##### 1ª versão: 25/agosto/2021 <br> (Atualizado em: `r format(Sys.Date(),"%d/%B/%Y")`) <br> Altamira, Pará
