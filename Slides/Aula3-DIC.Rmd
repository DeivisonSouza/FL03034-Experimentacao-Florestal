...
<br>
## `r anicon::faa("pagelines", animate="horizontal", colour="green")` Delineamento Inteiramente <br> Casualizado `r anicon::faa("pagelines", animate="horizontal", colour="green")`
...
.font90[
- Existe alguma progênie que apresentou DAP médio significativamente maior do que outra?
- A resposta para esta pergunta será alcançada aplicando-se o teste de hipótese (Teste F) da ANOVA-DIC.
<br>
