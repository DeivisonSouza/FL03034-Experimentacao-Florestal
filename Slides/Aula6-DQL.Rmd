...
[3 - Fontes de variações adicionais](#fv)

[4 - Controle Local](#cl)

[5 - Princípios básicos](#pb)

[6 - Croqui de experimento em DQL - Exemplo](#croqui)
...
```{r echo=F, out.width='50%', fig.align='center', fig.cap='', dpi=600}
da <- labestData::PimentelEg6.2
ggplot(da, aes(coluna, linha, fill = "white")) +
  geom_tile(aes(color = "black")) +
  scale_fill_identity() +
  labs(x = "Gradiente de Irrigação -->",
       y = "Gradiente de Fertilidade -->") +
  geom_text(mapping = aes(label = sprintf("%s", varied))) +
  #theme_bw() +
  theme(axis.title = element_text(size = 20),
        axis.text = element_text(size = 12, color = "black"),
  	    axis.title.y = element_text(angle = 90),
        legend.position = "none") +
  scale_x_discrete(labels = paste("C", 1:5)) +
  scale_y_discrete(labels = paste("L", 1:5)) +
  coord_fixed()
```
