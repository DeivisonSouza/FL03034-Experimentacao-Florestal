...
anova <- tibble("Fonte de variação" = c("Entre Tratamento", 
                ...
                "Graus de Liberdade" = c("I-1", 
                                        "I(J-1)", 
                                        "IJ-1"),
                "Soma de Quadrados (SQ)" = c("SQTrat.", 
                                        "SQR", 
                                        "SQTot."),
                "Quadrado Médio (QM)" = c("QMT = SQTrat./I-1", 
                                        "QMR = SQR/I(J-1)", 
                                        "-"),
                "Fcalculado" = c("QMT/QMR", 
                                        "-", 
                                        "-"),
...
.font90[
A SQ<sub>Total</sub> fornece a variação total dos dados da variável resposta no experimento.
]
]
...
### Quadro de Anova - Estatística F-Snedecor

Hipóteses estatísticas para o Teste “F de Snedecor “da ANOVA de um DIC.
