...
.pull-right-9[
T1, T2, T3,...,TI = Soma dos valores da variável y<sub>ij</sub> dentro do *i*-ésimo tratamento

, , ,...,= Média aritmética dos valores da variável “yij” dentro do i-ésimo tratamento.
]
