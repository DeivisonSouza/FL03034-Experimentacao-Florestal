...
[7 - DIC - Modelo Estatístico](#dicme)
...
- Em um DIC têm-se duas fontes de variação: 
**Fonte 1**: Efeitos dos tratamentos
o fator em estudo (tratamentos) e o erro aleatório.
...
É uma técnica estatística que permite decompor a .orange[variação total] existente no experimento em variação devido à diferença entre efeitos dos tratamentos e na variação devido ao acaso (erro experimental ou resíduo).
