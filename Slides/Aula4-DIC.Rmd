...
.pull-left-9[
Para um experimento em DIC com **I** tratamentos (i = 1, 2, 3..., I) e **J** repetições (j = 1, 2, 3..., J), tem-se a seguinte representação genérica:
<br><br>
...
Passos para o preenchimento do quadro de ANOVA - DIC.
<br><br>

**1° PASSO**: Calcular os graus de liberdade (tratamento, erro experimental e total).

**2° PASSO**: Calcular as somas de quadrado (tratamento, erro experimental e total).

**3° PASSO**: Calcular os quadrados médios (tratamento, erro experimental).

**4° PASSO**: Calcular o valor da estatística *F-Snedecor*.
